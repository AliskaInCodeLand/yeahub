              ...
              <ul className={styles.questions_list}>
                <li>
                  <div className={styles.questions_item}>
                    <img
                      src="./../../public/Images/question1.svg"
                      alt="question1"
                    />
                    <div>
                ...
                <li>
                  <div className={styles.questions_item}>
                    <img
                      src="./../../public/Images/question2.svg"
                      alt="question2"
                    />
                    <div>
                      <p className={styles.question_title}>
                ...
                <li>
                  <div className={styles.questions_item}>
                    <img
                      src="./../../public/Images/question3.svg"
                      alt="question3"
                    />
                    <div>
                ...
                <li>
                  <div className={styles.questions_item}>
                    <img
                      src="./../../public/Images/question4.svg"
                      alt="question4"
                    />
                    <div>
                      <p className={styles.question_title}>
          ...
          <div className={styles.simulator_advantages}>
            <ul className={styles.advantages_list}>
              <li className={styles.advantages_item}>
                ...
                <p>
                  Наш тренажёр предоставляет уникальный шанс углубить свои
            ...
            <NavLink to={`/interview-preparation`}>
              {({ isActive }) => (
                <span className={isActive ? styles.btnActive : styles.btn}>
                  Начать обучение
                </span>
              )}
            </NavLink>
