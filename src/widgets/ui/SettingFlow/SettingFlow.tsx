...
import NavigationLink from "../../../features/interview-preparation/NavigationLink/NavigationLink";
import SelectSpecialization from "../../../features/interview-preparation/SelectSpecialization/SelectSpecialization";
import SelectComplexity from "../../../features/interview-preparation/SelectComplexity/SelectComplexity";
import { SetQuestionCount } from "../../../features/interview-preparation/SetQuestionCount/SetQuestionCount";
import type { IMockTestProps } from "../../../entities/interview-preparation/model/types";

export const SettingFlow = ({ settingsQuiz, setSettingQuiz }: IMockTestProps) => {
  return (
    <>
      <NavigationLink />
