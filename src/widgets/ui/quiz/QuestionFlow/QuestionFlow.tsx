...
import { allResetAnswers, selectAnswer } from "../../../../entities/quiz/quizAnswerSlice";
import { resetQuiz, setQuiz } from "../../../../entities/quiz/quizSlice";
import { QuestionCard } from "../../../../entities/quiz/ui/QuestionCard/QuestionCard";
  ...
  return (
    <>
      <div style={{ display: "flex", marginBlock: 24 }}>
        ...
        <NavLink to={"/interview-preparation"}>Собеседование</NavLink>
        <div
          style={{
            width: "20px",
            display: "flex",
